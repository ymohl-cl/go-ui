...
func (s *SStat) Init(data *database.Data) error {
	var x int32
	var y int32
...
func (s *SStat) Update(data *database.Data) error {
	return nil
}

func (s *SStat) GetObjs() []*objects.ObjectType {
	return s.sObjs
}

func (s *SStat) AddLetterToInput(str string) {
	return
}

func (s *SStat) GetStaticObjs() []*objects.ObjectType {
	return s.sObjs
}

func (s *SStat) GetDynamicObjs() []*objects.ObjectType {
	return nil
}

func (s *SStat) SetNotice(str string) {
	return
}
